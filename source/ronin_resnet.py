...
from model_yolo26_1d import YOLO26_1D_Regressor, MuSGD, reset_bn_stats

_input_channel, _output_channel = 6, 2
_fc_config = {'fc_dim': 512, 'in_dim': 7, 'dropout': 0.2, 'trans_planes': 128}


def get_model(arch, load_pretrained=True, pretrain_ckpt='../output/pretrain_ridi_v2/ridi_pretrained_full_v2.pt'):
    ...
    if load_pretrained:
        ...
        print("[YOLO26-1D] Training from scratch (no pretrained checkpoint loaded).")
